  ...
  return (
    <Suspense fallback={<div>Loading presale...</div>}>
      ...
      <PresaleClientContent
        // contributorCount={1260}
        contributorCount={1107 + presaleData.contributorCount || 0}
        // totalRaised={58450 / 179}
        totalRaised={159.1005586592 + presaleData.totalRaised || 0}
        usdRaised={28479 + presaleData.usdRaised || 0}
        // usdRaised={58450}
